          ...
          children: [
            ...
            if (!_editing) ...[
              PeriodDetailView(
                ...
                isPaid: widget.existing.isPaid,
                consumptionIcon: Icons.electric_meter_outlined,
                consumptionValue:
                    _isMeter
                        ? "${_fmtKwhForm(widget.existing.previousKwh)} → ${_fmtKwhForm(widget.existing.newKwh)} kWh"
                            "${widget.existing.consumptionKwh != null ? "  (${_fmtKwhForm(widget.existing.consumptionKwh!)} kWh)" : ""}"
                        : null,
